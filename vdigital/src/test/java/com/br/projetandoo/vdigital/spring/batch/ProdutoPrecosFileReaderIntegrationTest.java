...
public class ProdutoPrecosFileReaderIntegrationTest {
	...
	@Test
	public void testProdutoPrecosFileReader_leituraArquivoBlocoUnico() throws Exception {
		...
		assertEquals(readCount.intValue(), 49);
	}
