...
public class ProdutoListener extends ItemListenerSupport<Produto, Produto> {

	private Logger logger = LoggerFactory.getLogger(ProdutoListener.class);
	...
	public void onReadError(Exception e) {
		...
		if(e instanceof FlatFileParseException) {
			...
			mensagemErro.append("Um erro ocorreu lendo a linha " + ffpe.getLineNumber() + "\n");
